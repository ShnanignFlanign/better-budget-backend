...
CORS(deposits, origins=['https://better-budget.herokuapp.com', 'http://better-budget.herokuapp.com', 'https://localhost:3000', 'http://localhost:3000'], supports_credentials=True)
CORS(user, origins=['https://better-budget.herokuapp.com', 'http://better-budget.herokuapp.com', 'https://localhost:3000', 'http://localhost:3000'], supports_credentials=True)
